      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">Where Development Meets Artificial Intelligence</p>
            <p>Tech Squad Solutions is a leading enterprise software developer focused on secure technology solutions for businesses' digital transformation.</p>
            <div className="social-links">
              ...
              <a href="https://wa.me/919274488477" className="social-link" aria-label="WhatsApp"><WhatsAppIcon /></a>
            </div>
          </div>
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li><Link to="/services">AI & ML Development</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-contact">
            ...
            <div className="footer-contact-item">
              ...
              <a href="https://www.google.com/maps/place/Nilkanth+Heights,+Sarthana+Jakat+Naka,+Shantivan-2,+Nana+Varachha,+Surat,+Gujarat+395013" target="_blank" rel="noopener noreferrer">
                Nilkanth Heights, Sarthana Jakat Naka, Surat, Gujarat 395013
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Tech Squad Solutions. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
